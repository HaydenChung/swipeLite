...
/***/ function(module, exports, __webpack_require__) {
	...
	var wrapper = document.querySelector('.container_wrapper'),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Carousel = function () {
	    ...
	    _createClass(Carousel, [{
	        ...
	        key: "_circling",
	        value: function _circling() {
	            var isSwiping = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
	        ...
	        key: "_circleWithBlock",
	        value: function _circleWithBlock() {
	        ...
	        key: "_staticBlock",
	        value: function _staticBlock() {
	            this._moveBlock(this.leadingBlock * -this.nodeOuterWidth);
	        }
	    }, {
	        key: "_moveBlock",
	        value: function _moveBlock(x) {
	        ...
	        value: function _initiate() {
	            ...
	            this._staticBlock();
	            for (var i = 0; i < this.fakeBlock; i++) {
	                this.container.appendChild(this.nodesArr[i].cloneNode(true));
	            }
	            for (var j = this.nodesArr.length - 1; j >= this.nodesArr.length - this.fakeBlock; j--) {
	        ...
	        value: function _resize() {
	            ...
	            for (var i = 0, lenI = this.nodesArr.length; i < lenI; i++) {
	        ...
	        value: function slide() {
	            ...
	            this.slideTimer = setInterval(function () {
	                _this5.leadingBlock++;
	                _this5.container.style.transitionDuration = _this5.transDuration + "ms";
	                _this5._staticBlock();

	                setTimeout(function () {
	                    _this5._circleWithBlock();
	                }, _this5.transDuration);
	            }, 2500);
	            return this;
	        }
	    }, {
	        ...
	        value: function prevBtn() {
	            ...
	            if (this.pressing === false) {
	                ...
	                this._staticBlock();
	                setTimeout(function () {
	                    _this6._circleWithBlock();
	                    _this6.pressing = false;
	                    if (_this6.slideRestart === true) {
	                        _this6.slide();
	                    }
	                }, this.transDuration);
	            }
	        ...
	        value: function nextBtn() {
	            ...
	            if (this.pressing === false) {
	                ...
	                this._staticBlock();
	                setTimeout(function () {
	                    _this7._circleWithBlock();
	                    _this7.pressing = false;
	                    if (_this7.slideRestart === true) {
	                        _this7.slide();
	                    }
	                }, this.transDuration);
	            }
